...
String get = (String) request.getSession().getAttribute("webt");
//String get = (String) request.getAttribute("Value");
System.out.println(get);
System.out.println(get.length());
String userip = request.getParameter("Enter");
    System.out.println(userip);
    System.out.println(userip.length());
if(userip.equals(get))
           {
